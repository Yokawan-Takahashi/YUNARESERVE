...
<head>
    ...
    <title>キャンセル完了 — {{ $tenant?->company_name ?? config('app.name') }}</title>
...
<body class="bg-gray-50">
    ...
    <main class="max-w-lg mx-auto p-6">
        <div class="bg-white rounded shadow p-8 text-center">
            ...
            <h2 class="text-2xl font-bold mb-2">キャンセルが完了しました</h2>
            <p class="text-gray-600 mb-6">キャンセル確認メールをお送りしました。</p>
